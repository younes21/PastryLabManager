...
export const articles = pgTable("articles", {
  ...
  // comptabilité
  expenseAccountId: integer("expense_account_id").references(() => accountingAccounts.id), // compte charges achats
  incomeAccountId: integer("income_account_id").references(() => accountingAccounts.id), // compte produits ventes
  stockAccountId: integer("stock_account_id").references(() => accountingAccounts.id), // compte de stock
...
export const inventoryOperationsRelations = relations(inventoryOperations, ({ many }) => ({
  items: many(inventoryOperationItems),
}));

export const inventoryOperationItemsRelations = relations(inventoryOperationItems, ({ one }) => ({
